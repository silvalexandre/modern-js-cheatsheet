...
Este documento é um conjunto de "cheatsheet" para JavaScript que você frequentemente encontrará em projetos modernos e na maioria de exemplos de códigos atuais.

Este guia não tem a intenção de te ensinar JavaScript do zero, mas sim ajudar desenvolvedores com conhecimentos básicos a se familiarizarem com códigos modernos.
...
> **Nota:** Muito dos conceitos apresentados aqui vem de uma atualização do JavaScript (ES2015, também conhecida como ES6). Você pode encontrar as novas funcionalidades desta atualização [aqui](http://es6-features.org).
...
- [Google](https://www.google.com/) para específicos blogs e recursos
...
- [Modern JavaScript *cheatsheet*](#modern-javascript-cheatsheet)
  ...
  * [Noções](#notions)
    ...
    + [*Arrow function*](#-arrow-function)
      ...
      - [Material complementar](#useful-resources)
    + [Parâmetros padrão de uma função](#function-default-parameter-value)
    ...
    + [Desestruturação de objetos e listas](#destructuring-objects-and-arrays)
      ...
      - [Material complementar](#useful-resources-1)
    + [Métodos de array - map / filter / reduce](#array-methods---map--filter--reduce)
    ...
    + [Abreviação em nomes de propriedades - Objetos](#object-property-shorthand)
    ...
    + [Imports / Exports](#imports--exports)
      - [Explicação com código](#explanation-with-sample-code-1)
